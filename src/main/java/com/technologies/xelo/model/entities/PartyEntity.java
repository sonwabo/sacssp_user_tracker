...
public class PartyEntity implements Serializable, Cloneable {
    ...
    @Column(nullable = false, name = "internationalinstitutionname", length = 100, unique = true, columnDefinition="TEXT")
    @Basic
    public String  internationalinstitutionname;

    @Column(nullable = false, name = "internationalcompletionyear", length = 100, unique = true, columnDefinition="TEXT")
    @Basic
    public String internationalcompletionyear;

    @Column(nullable = false, name = "internationalinstitutionemail", length = 100, unique = true, columnDefinition="TEXT")
    @Basic
    public String  internationalinstitutionemail;

    @Column(nullable = false, name = "internationalqualificationname", length = 100, unique = true, columnDefinition="TEXT")
    @Basic
    public String  internationalqualificationname;

    @Column(nullable = false, name = "internationalsaqavalidation", length = 100, unique = true, columnDefinition="TEXT")
    @Basic
    public String  internationalsaqavalidation;
    @Column(nullable = false, name = "internationalsaqaverification", length = 100, unique = true, columnDefinition="TEXT")
    @Basic
